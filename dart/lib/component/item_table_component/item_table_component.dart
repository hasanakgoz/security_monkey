...
@Component(
    selector: 'item-table',
    templateUrl:
        'packages/security_monkey/component/item_table_component/item_table_component.html',
...
class ItemTableComponent extends PaginatedTable implements DetachAware {
  ...
  void serviceNow(int item_id) {
    String link = "/api/1/servicenow/report/item/" + item_id.toString();
//    window.location.assign(link);
    print("Clicked on Item : $item_id, calling url: $link");
  }
